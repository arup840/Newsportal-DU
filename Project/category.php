...
<div class="contentsection contemplete clear">
	<div class="maincontent clear">
		...
		$statement = $db->prepare("SELECT * FROM news WHERE category_id=? ORDER BY category_id DESC");
		...
		$statement = $db->prepare("SELECT * FROM news WHERE category_id=? ORDER BY category_id DESC LIMIT $start, $limit");
		$statement->execute(array($id));
